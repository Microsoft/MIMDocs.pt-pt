---
title: "Recuperação de Palavra-passe Self-Service | Microsoft Identity Manager"
...
## Preparar o MIM para funcionar com a autenticação multifator
...
### Registar o fornecedor de autenticação multifator no Azure
