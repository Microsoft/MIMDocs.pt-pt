---
title: Obtenha certificados de utilizador ! Microsoft Docs
description: ''
keywords: ''
author: billmath
ms.author: billmath
...
ms.locfileid: "92762046"
---
# <a name="get-user-certificates"></a>Obtenha certificados de utilizador
Obtém a lista de certificados associados a um utilizador especificado. Os certificados aposentados são filtrados da lista.
...
---------|---------
GET     |/CertificadosManagement/api/v1.0/certificates
...
No sucesso, devolve uma lista de [objetos microsoft.clm.shared.certificates.X509ClmCertificate](https://msdn.microsoft.com/library/microsoft.clm.shared.certificates.x509clmcertificate(v=vs.100).aspx) com as seguintes propriedades:
...
Emissor | O emitente.
NotAfter | A data e a hora após a qual o certificado deixou de ser válido.
NotBefore | A data e a hora em que o certificado se torna válido.
Nome do Solicitador | A conta que solicitou a certidão.
SerialNumber | O número de série do certificado.
Estado | O estado do certificado.
...
Esta secção dá um exemplo para obter os certificados que estão associados a um utilizador.
