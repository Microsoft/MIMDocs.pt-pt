...
ms.locfileid: "94492383"
---
# <a name="supported-platforms-for-mim-2016"></a>Plataformas suportadas para o MIM 2016

A tabela seguinte descreve as plataformas suportadas e a versão de cada componente do Microsoft Identity Manager 2016. As versões marcadas com um * só são suportadas no Pacote de Serviços MIM 2016 1, no Service Pack 2 ou num hotfix posterior. As versões marcadas com ** só são suportadas no Pack de Serviços MIM 2016 ou num hotfix posterior. As versões marcadas com "NR", para não recomendado, são suportadas, mas não são recomendadas se iniciar uma nova implantação daquela plataforma para MIM.
...
| | Exchange para o aprovisionamento de caixas de correio e Sincronização da GAL (opcional)|Exchange Server 2013 SP1<br/>Exchange Server 2016 *<br/>Servidor de Troca 2019 ** |
...
| | Armazém de dados | System Center 2012 Service Manager SP1 <br/> System Center 2012 R2 Service Manager <br/> System Center 2016 Service Manager * (com 4.4.1459)<br/> Gestor de serviços do System Center 2019 ** |
...
| **Extensões e Suplementos do MIM** | Windows | Windows 7<br/>Windows 8.1<br/>Windows 10 |
| | Integração com o Outlook (opcional) | Outlook 2013 (no Windows, exceto Click-To-Run) <br/> Outlook 2016 (no Windows 10, exceto Click-To-Run) *<br/>Perspetivas para o Microsoft 365 (no Windows 10, incluindo Click-To-Run) ** |
...
| **Gestão de Certificados do MIM** (Aplicação) | Windows | Windows 8.1<br/>Windows 10 |
| **Gestão de Certificados MIM** (Cliente a granel) | Windows | Windows 7 |
| **Gestão de Certificados MIM** (cartão inteligente baseado em Cliente ActiveX) | Windows | Windows 7 <br/>Windows 8.1 <br/> Windows 10 |
...
| | Servidor de correio (opcional) | Exchange Server 2013 SP1 <br/> Exchange Server 2016 * |
