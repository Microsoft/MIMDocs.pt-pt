---
title: Obter certificados de utilizador | Microsoft Docs
description: 
keywords: 
author: msmbaldwin
ms.author: mbaldwin
...
---
# <a name="get-user-certificates"></a>Obter certificados de utilizador
Obtém a lista de certificados associados ao utilizador especificado (certificados extintos são filtrados).
...
Com êxito, devolve uma lista de JSON serializado [Microsoft.Clm.Shared.Certificates.X509ClmCertificate](https://msdn.microsoft.com/library/microsoft.clm.shared.certificates.x509clmcertificate(v=vs.100).aspx) objetos com as seguintes propriedades:
...
Emissor | O emissor.
NotAfter | A data e hora após o qual o certificado já não é válido
NotBefore | A data e hora em que o certificado fica válido
RequesterName | A conta que pediu o certificado.
