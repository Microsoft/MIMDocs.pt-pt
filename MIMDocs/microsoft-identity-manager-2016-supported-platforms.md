...
ms.locfileid: "79044077"
---
# <a name="supported-platforms-for-mim-2016"></a>Plataformas suportadas para o MIM 2016

A tabela seguinte descreve as plataformas suportadas e a versão de cada componente do Microsoft Identity Manager 2016. As versões marcadas com um * só são suportadas no MIM 2016 service pack 1. As versões marcadas com ** só são suportadas no pacote de serviço mim 2016 2 ou num hotfix posterior. As versões marcadas com "NR", para não recomendados, são suportadas, mas não são recomendadas se iniciarem uma nova implantação dessa plataforma para MIM.
...
| | Nível funcional de Diretório Ativo para o fornecimento de utilizadores, PCNS e GAL Sync | Windows 2000 (NR)<br/>Windows Server 2003<br/>Windows Server 2008<br/>Windows Server 2008 R2<br/>Windows Server 2012<br/>Windows Server 2012 R2<br/>Windows Server 2016 *
...
| | Diretório Ativo para o fornecimento de utilizadores, PCNS e GAL Sync (opcional)|Windows Server 2008 R2 SP1<br/>Windows Server 2012<br/>Windows Server 2012 R2 <br/> Windows Server 2016 *<br/> Windows Server 2019 ** |
...
| |Cenário PAM: Servidor do Windows | Windows Server 2012 R2 (NR) <br/> Windows Server 2016 * |
| |Cenário PAM: Diretório ativo para o ambiente de bastião FLORESTA PAM | Windows Server 2012 R2 (NR) <br/> Windows Server 2016 * |
| |Cenário PAM: Diretório ativo para florestas existentes (CORP) existentes | Windows Server 2008 <br/> Windows Server 2008 R2 * <br/> Windows Server 2012 * <br/> Windows Server 2012 R2 * <br/> Windows Server 2016 * |
...
| | Armazém de dados | System Center 2012 Service Manager <br/> System Center 2012 R2 Service Manager <br/> System Center 2016 Service Manager * (com 4.4.1459)<br/> System Center 2019 Gestor de Serviços ** |
...
| | Integração com o Outlook (opcional) | Outlook 2010 (no Windows, exceto Click-to-Run)<br/>Outlook 2013 (no Windows, exceto Click-to-Run) <br/> Outlook 2016 (no Windows 10, exceto Click-To-Run) *<br/>Office 365 Outlook (no Windows 10, incluindo Click-To-Run) ** |
...
| | Browser | Internet Explorer suportados navegadores com Silverlight |
